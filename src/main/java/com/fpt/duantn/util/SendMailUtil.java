...
public class SendMailUtil {
	...
	public void sendMailOrder(Bill bill) {
		...
		for (BillDetail oderDetail : listOrderDetails) {
			content.append("<tr>\r\n"
					...
					+ oderDetail.getProductDetail().getProduct().getName() + " </td>\r\n"
					+ "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;\"> "
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "                                                            <p>"
						+ dt.format(bill.getBillCreateDate()) + "</p>\r\n"
						+ "                                                        </td>\r\n"
						+ "                                                    </tr>\r\n"
						+ "                                                </table>\r\n"
						+ "                                            </div>\r\n"
	...
	public void sendMailOrderSuccess(Bill order) {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<BillDetail> listOrderDetails = billDetailService.findByBillId((order.getId()));
		StringBuilder content = new StringBuilder();
...
//					+ oderDetail.getgetProduct().getImage() + ">\r\n"
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "                                                            <p style=\"font-weight: 800;\">Ngày đặt hàng</p>\r\n"
						+ "                                                            <p>"
						+ dt.format(order.getBillCreateDate()) + "</p>\r\n"
						+ "                                                        </td>\r\n"
						+ "                                                    </tr>\r\n"
						+ "                                                </table>\r\n"
						+ "                                            </div>\r\n"
	...
	public void sendMailOrderDeliver(Bill order) {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<BillDetail> listOrderDetails = billDetailService.findByBillId(order.getId());
		StringBuilder content = new StringBuilder();
...
//					+ oderDetail.getProduct().getImage() + ">\r\n"
	...
	public void sendMailOrderCancel(Bill order) {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<BillDetail> listOrderDetails = billDetailService.findByBillId(order.getId());
		StringBuilder content = new StringBuilder();
